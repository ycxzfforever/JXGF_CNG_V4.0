...
extern uint8_t UploadIdCount;     //上传流水失败次数。
extern uint8_t UpLoadClassIdCount;//加气机上传上下班记录失败次数。
extern uint8_t UpLoadModifyCount; //加气机上传参数修改记录失败次数。
...
extern uint8_t SendBack485Buf[250];
extern uint8_t RecBack485Buf[250];
...
extern uint8_t WaitForCom(uint8_t com);
/********************************************************
**结构名称:Reply51
...
typedef struct 
{
    ...
    uint8_t   gastype;                //气品代码，1字节，0-CNG，1-LNG。
    uint8_t   measuretype;            //计量单位，1字节，0-标方，1-Kg。
